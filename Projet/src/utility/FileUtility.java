...
public class FileUtility implements Serializable {
	...
	/**
	 * R�ajuste le tableau à deux dimensions d'ID de cases de sorte à ce qu'il soit rectangle
	 * (toute les lignes contiendront le m�me nombre de cases c'est à dire nbCasesLigne cases).
	...
	/**
	 * R�ajuste le tableau à deux dimensions d'ID de cases de sorte à ce qu'il soit rectangle
	 * (toute les lignes contiendront le m�me nombre de cases c'est à dire autant que la ligne qui contenait le plus de cases).
	 * @param tabMap Le tableau à rectangulariser
	 */
	...
	/**
	 * Affiche sur la console le tableau à deux dimensions d'ID de cases entré en paramètre (utile pour du d�bugage).
